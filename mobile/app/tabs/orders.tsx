    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity style={styles.loginBtn} onPress={() => router.push('/tabs/menu' as any)}>
        ...
        >
          {filteredOrders.map(order => {
            ...
            return (
              <TouchableOpacity key={order._id} style={styles.orderCard} onPress={() => router.push(`/order/${order._id}` as any)} activeOpacity={0.85}>
                {/* Header */}
                ...
                <View style={styles.orderFooter}>
                  ...
                  {order.status === 'delivered' && (
                    <TouchableOpacity style={styles.reorderBtn} onPress={() => router.push('/tabs/menu' as any)}>
